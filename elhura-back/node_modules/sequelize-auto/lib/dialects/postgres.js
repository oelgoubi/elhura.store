...
exports.postgresOptions = {
     ...
     */
    isSerialKey: (record) => {
        const isSequence = (val) => !!val && lodash_1.default.startsWith(val, 'nextval') && lodash_1.default.includes(val, '_seq') && lodash_1.default.includes(val, '::regclass');
        return (lodash_1.default.isObject(record) && (isSequence(record.extra) || isSequence(record.defaultValue)));
    },
    /**
