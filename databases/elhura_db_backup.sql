...
INSERT INTO `Article` VALUES (1,1,3,'Laptop MSI',500,480,'http://localhost:3000/api/files/laptop1.jpg','MSI Laptop, Core i7-10th generation'),(4,1,3,'Dell',300,295,'https://images-na.ssl-images-amazon.com/images/I/61-KUPluVYL._AC_SL1500_.jpg','Use both ground coffee and k-cup pods. Multiple brew sizes: brew an 8, 10, or 12-cup carafe and an 237, 296, or 355ml (8, 10, or 12 oz. ) cup '),(5,1,3,'Asus',300,295,'https://images-na.ssl-images-amazon.com/images/I/61-KUPluVYL._AC_SL1500_.jpg','Use both ground coffee and k-cup pods. Multiple brew sizes: brew an 8, 10, or 12-cup carafe and an 237, 296, or 355ml (8, 10, or 12 oz. ) cup '),(6,1,3,'Alienware',1000,950,'http://localhost:3000/api/files/laptop4.jpg','The best gaming laptop the universe has ever known.'),(7,1,3,'Microsoft Surface',375,365,'http://localhost:3000/api/files/laptop5.jpg','Easy to use.');
...
INSERT INTO `CartElement` VALUES (1,5,4,1);
...
INSERT INTO `Category` VALUES (1,'Laptop'),(2,'Multimedia'),(3,'Electromenager'),(4,'Hi-Fi'),(5,'Accessoires'),(6,'TV'),(7,'Smartphone'),(8,'Console');
...
INSERT INTO `Client` VALUES (4,1,NULL,NULL,NULL,'$2a$08$QGcviDtF8EQxvShHICb2x.9TtLrgsZlMvHfsr5ptJ/mARNwkgS1OO','mb.raharison@gmail.com',NULL,NULL,NULL,NULL,1,'496969','2021-02-08 11:03:36','2021-02-08 11:04:43'),(14,1,NULL,NULL,NULL,'$2a$08$CcVfoMYvjHCf7RUbO8blGO9XvGGa8NnjpQ9LPAHDSnJuvI2TCwVmu','phales.harrison@gmail.com',NULL,NULL,NULL,NULL,1,'287926','2021-02-27 20:53:52','2021-02-27 20:54:11');
...
-- Dump completed on 2021-02-28 17:10:38
